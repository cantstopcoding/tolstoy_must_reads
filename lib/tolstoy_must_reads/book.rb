class TolstoyMustReads::Book
    ...
    def self.scrape_website
        ...
        book = self.new
        book.name = doc.search("h2.titlestyled__TitleWrapper-sc-11j6mg5-0.duRXkN").text
        book.summary = doc.search("p.paragraph-wraperstyled__ParagraphWrapper-sc-1xg03x1-0.gnTgqd").text
